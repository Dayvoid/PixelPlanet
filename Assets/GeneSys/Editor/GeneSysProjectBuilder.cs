    ...
    public static class GeneSysProjectBuilder
    {
        ...
        public static void Build()
        {
            ...
            var definitions = new List<MaterialDefinition>
            {
                ...
                Define(131, "Detritus", MaterialCategory.Granular, new Color(0.28f,0.22f,0.12f,1), 0.42f, 0.04f, 28, 0.4f, 0.35f, 0.09f, 1.4f, 0.02f, 0.9f, 0.85f, 180, 400, 0.02f, 0, 131, 131, 11, true, true, 0, 0.6f, 220f, 170f, 0.7f, 0.55f)
            };
